...
CREATE TABLE `tags` (
  ...
  KEY `id_post` (`id_post`),
  CONSTRAINT `tags_ibfk_1` FOREIGN KEY (`id_post`) REFERENCES `posts` (`id_post`)
...
INSERT INTO `tags` VALUES (4,'test'),(8,'test'),(9,'test'),(7,'language');
...
-- Dump completed on 2018-07-05 12:58:10
