...
CREATE TABLE `tags` (
  ...
  KEY `tags_ibfk_1` (`id_post`),
  CONSTRAINT `tags_ibfk_1` FOREIGN KEY (`id_post`) REFERENCES `posts` (`id_post`) ON DELETE CASCADE
...
INSERT INTO `tags` VALUES (4,'test'),(8,'test'),(9,'test'),(7,'language'),(12,'motherfucker'),(12,'sonofabitch');
...
-- Dump completed on 2018-07-07 12:05:40
