...
CREATE TABLE `tags` (
  ...
  KEY `id_post` (`id_post`),
  CONSTRAINT `id_post` FOREIGN KEY (`id_post`) REFERENCES `posts` (`id_post`) ON DELETE CASCADE
...
INSERT INTO `tags` VALUES (4,'test'),(4,'first');
...
-- Dump completed on 2018-07-02 15:06:49
